...
public class AttendanceRecordSpecification {
    ...
    private static final List<String> filterKeys = List.of("date", "student.lrn", "student.firstName", "student.status", "student.lastName","enrollmentDate","yearLevel", "section.adviser.firstName", "schoolYear", "section", "student.gender", "student.contactNumber");
    @Getter
    private static final List<String> sortedKeys = filterKeys;

    public static Specification<AttendanceRecord> filter(Map<String, String> params) {
